...
class SimplierInputAgentV2(AgentBase):
    ...
    def _sampled_outputs_to_action_dict(sampled_outputs: dict[str, Tensor], state: Observations) -> dict[str, dict[str, int]]:
        ...
        return {
            ...
            "Attack": {
                ...
                else SimplierInputAgentV2._get_attack_target_index(attack_target_pos[0], attack_target_pos[1], state)
            }
        }
    ...
    @staticmethod
    def load(name: str | None = None) -> 'SimplierInputAgentV2':
        agent_name = name if name is not None else "SimplierInputAgentV2"
        jar = Jar("saved_agents")
        ...
        agent = SimplierInputAgentV2(**constructor_params)
